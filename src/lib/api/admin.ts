import { affirmationsApiResponse, getAffirmationCategoriesApiResponse, getRecentActivitiesApiResponse, getUserCaloriesApiResponse, getUserSummaryApiResponse, getUserWorkoutApiResponse } from "../types/admin";
...
export async function getUserSummary(token:string,):Promise<getUserSummaryApiResponse>{
    return howl(`/admin/users/summary`,{token});
}
